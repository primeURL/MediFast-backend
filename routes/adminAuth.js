...
router.post("/signup", async (req, res) => {
	try {
		...
		user = await new AdminSchema({ ...req.body, password: hashPassword, confirmPassword:hashConfirmPassword }).save();
...
//     try {
//         const response = await AdminSchema.findOne({_id:req.params.userId})
